...
$(document).ready(function () {
    ...
    $('table#search tbody tr').live('mousedown', function (e) {
        ...
        tr.addClass('selectedrow').fadeTo('slow', 0.2);
        ...
        $('body').mouseup(function () {
            ...
            tr.fadeTo('fast', 1).removeClass('selectedrow');
    ...
    function reorder() {
        ...
        $('table#search tbody tr').each(function () {
            ...
            this.cells[1].innerHTML = position;
