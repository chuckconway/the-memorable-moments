<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<TheMemorableMoments.UI.Models.Views.Comments.ManageCommentsView>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	manage comments - <%= Model.User.DisplayName %>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="nav"> 
		<ul style="float:right;" >
            <li><a href="/<%= Model.User.Username %>/photos/">Photos</a></li>
            <li><a href="/<%= Model.User.Username %>/photos/search">Search</a></li>
 			<li><a class="youarehere" href="/<%= Model.User.Username %>/comments">Comments</a></li> 
		</ul> 
    ...
    <div id="photoarea" class="hidden">
        ...
        <%= Model.RenderViewNavigation(Model.View, Model.User) %>
                ...
                <%= Html.Grid(Model.Pagination.PageSet).Attributes(new Dictionary<string, object>{{"class","width100percent results"}})
                    ...
                    .Columns(c => c.For(x => string.Format("<p class=\"commentdate\" >{0} </p>{1}", x.Comment.CommentDate.ToString("f"), x.Comment.Text)).DoNotEncode().Named(string.Empty)) 
                %>
