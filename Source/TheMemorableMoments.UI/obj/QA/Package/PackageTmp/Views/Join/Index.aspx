...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">      
        ...
        <p style="margin-top:60px;">if you'd like to <strong>join</strong> the beta please submit your <strong>email address</strong> and we'll send you a token when we increase the site capacity.</p>
