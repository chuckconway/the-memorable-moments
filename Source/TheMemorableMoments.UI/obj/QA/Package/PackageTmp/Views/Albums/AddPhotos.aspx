...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="nav"> 
		<ul style="float:right;" >
           <li><a  href="/<%= Model.User.Username %>/albums/details/<%= Model.Album.AlbumId %>">Details</a></li>
           <li><a href="/<%= Model.User.Username %>/albums/photos/<%= Model.Album.AlbumId %>">Photos</a></li>
 		   <li><a class="youarehere" href="/<%= Model.User.Username %>/albums/addphotos/<%= Model.Album.AlbumId %>">Add</a></li> 
		</ul> 
		<br class="clearboth" />
	</div>  

    <ul style="text-align: right; margin-bottom: 40px;" class="hyperlinks" id="subviewlinks">
            <li><a class="youarehere" href="/<%= Model.User.Username %>/albums/addphotos/<%= Model.Album.AlbumId %>">All</a></li>
            <li><a  href="/<%= Model.User.Username %>/albums/tags/<%= Model.Album.AlbumId %>">Tags</a></li>
            <li><a  href="/<%= Model.User.Username %>/albums/searchphotos/<%= Model.Album.AlbumId %>">Search</a></li>
   </ul>
...
<asp:Content ID="Content4" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="/Scripts/Pages/albums/addphotos.js"></script>
