...
(function($){var
IE6=$.browser.msie&&/MSIE 6.0/.test(navigator.userAgent),Timer,IE6FIX;$.jnotifica_defaults={margin:0,position:'top',width:'all',align:'center',padding:10,background:'#000',zIndex:100,color:'#666',opacity:0.8,cursor:'pointer',msgCss:{fontSize:'12px',fontFamily:'Arial, sans-serif',textAlign:'left'},effect:'slide',speed:500,timeout:5000,clickClose:true,close:{text:'[X]',css:{color:'#fff',fontSize:'10px',position:'absolute',top:5,right:10,cursor:'pointer'}},onShow:function(main){},onClose:function(){},classes:''}
